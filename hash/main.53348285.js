this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    var Ps = "abcdefghijklmnopqrstuvwxyz",
        Ns = "statistics",
        Hs = "fail",
        Gs = {
            currentStreak: 0,
    ...
    function Bs() {
        var e = window.localStorage.getItem(Ns) || JSON.stringify(Gs);
        return JSON.parse(e)
    }
    ...
    function Ds(e) {
        ...
        s ? (o.guesses[t] += 1, a ? o.currentStreak += 1 : o.currentStreak = 1) : (o.currentStreak = 0, o.guesses.fail += 1), o.maxStreak = Math.max(o.currentStreak, o.maxStreak), o.gamesPlayed += 1, o.gamesWon += s ? 1 : 0, o.winPercentage = Math.round(o.gamesWon / o.gamesPlayed * 100), o.averageGuesses = Math.round(Object.entries(o.guesses).reduce((function (e, s) {
            ...
            function (e) {
                window.localStorage.setItem(Ns, JSON.stringify(e))
            }(o)
    }
    ...
    var Ys = "IN_PROGRESS",
        Us = "WIN",
        Js = "FAIL",
        Xs = ["Genius", "Magnificent", "Impressive", "Splendid", "Great", "Nice"],
        Ks = function (e) {
            n(t, e);
            var s = h(t);
            ...
            function t() {
                var e;
                a(this, t), r(p(e = s.call(this)), "tileIndex", 0), r(p(e), "rowIndex", 0), r(p(e), "solution", void 0), r(p(e), "boardState", void 0), r(p(e), "evaluations", void 0), r(p(e), "canInput", !0), r(p(e), "gameStatus", Ys), r(p(e), "letterEvaluations", {}), r(p(e), "$board", void 0), r(p(e), "$keyboard", void 0), r(p(e), "$game", void 0), r(p(e), "today", void 0), r(p(e), "lastPlayedTs", void 0), r(p(e), "lastCompletedTs", void 0), r(p(e), "hardMode", void 0), e.attachShadow({
                    mode: "open"
                }), e.today = new Date;
                var o = zs();
                ...
                })) : (e.boardState = o.boardState, e.evaluations = o.evaluations, e.rowIndex = o.rowIndex, e.solution = o.solution, e.letterEvaluations = Ms(e.boardState, e.evaluations), e.gameStatus = o.gameStatus, e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.gameStatus !== Ys && (e.canInput = !1), e.restoringFromLocalStorage = !0), e
            }
            return o(t, [{
                key: "evaluateRow",
                value: function () {
                ...
                key: "addLetter",
                value: function (e) {
                    this.gameStatus === Ys && (this.canInput && (this.tileIndex >= 5 || (this.boardState[this.rowIndex] += e, this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("letters", this.boardState[this.rowIndex]), this.tileIndex += 1)))
                }
            }, {
                key: "removeLetter",
                value: function () {
                    if (this.gameStatus === Ys && this.canInput && !(this.tileIndex <= 0)) {
                ...
                key: "submitGuess",
                value: function () {
                    if (this.gameStatus === Ys && this.canInput) {
                ...
                value: function () {
                    var e = this;
                    this.shadowRoot.appendChild(Fs.content.cloneNode(!0)), this.$game = this.shadowRoot.querySelector("#game"), this.$board = this.shadowRoot.querySelector("#board"), this.$keyboard = this.shadowRoot.querySelector("game-keyboard"), this.sizeBoard(), this.lastPlayedTs || setTimeout((function () {
                    ...
                    this.$game.addEventListener("game-key-press", (function (s) {
                        var a = s.detail.key;
                        "←" === a || "Backspace" === a ? e.removeLetter() : "↵" === a || "Enter" === a ? e.submitGuess() : Ps.includes(a.toLowerCase()) && e.addLetter(a.toLowerCase())
                        ...
                        (s.path || s.composedPath && s.composedPath()).includes(a) && ([Us, Js].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === Us && (a.setAttribute("win", ""), e.addToast(Xs[e.rowIndex - 1], 2e3)), e.gameStatus === Js && e.addToast(e.solution.toUpperCase(), 1 / 0), setTimeout((function () {
                            e.showStatsModal()
                ...
                value: function () {
                    var e = this;
                    this.shadowRoot.getElementById("debug-tools").appendChild(Ws.content.cloneNode(!0)), this.shadowRoot.getElementById("toast").addEventListener("click", (function (s) {
    ...
    customElements.define("game-app", Ks);
    ...
    var Qs = function (e) {
        ...
        return o(t, [{
            ...
            value: function () {
                var e = this;
                this.shadowRoot.appendChild(Vs.content.cloneNode(!0)), this.addEventListener("click", (function (s) {
    ...
    customElements.define("game-modal", Qs);
    ...
    var aa = [
        ...
        ta = function (e) {
            ...
            return o(t, [{
                ...
                value: function () {
                    var e = this;
                    this.shadowRoot.appendChild(Zs.content.cloneNode(!0)), this.$keyboard = this.shadowRoot.getElementById("keyboard"), this.$keyboard.addEventListener("click", (function (s) {
                        ...
                        if (!0 !== s.repeat) {
                            var a = s.key,
                                t = s.metaKey,
                                o = s.ctrlKey;
                            t || o || (Ps.includes(a.toLowerCase()) || "Backspace" === a || "Enter" === a) && e.dispatchKeyPressEvent(a)
                        }
                        ...
                        a.classList.add("row"), s.forEach((function (e) {
                            var s;
                            if (e >= "a" && e <= "z" || "←" === e || "↵" === e) {
                                if ((s = ea.content.cloneNode(!0).firstElementChild).dataset.key = e, s.textContent = e, "←" === e) {
                            ...
                            } else(s = sa.content.cloneNode(!0).firstElementChild).classList.add(1 === e.length ? "half" : "one");
                            a.appendChild(s)
    ...
    customElements.define("game-keyboard", ta);
    ...
    var ia = {
        ...
        la = function (e) {
            ...
            return o(t, [{
                ...
                value: function () {
                    var e = this;
                    this.shadowRoot.appendChild(oa.content.cloneNode(!0));
    ...
    var ua = function (e) {
        ...
        return o(t, [{
            ...
            value: function () {
                var e = this;
                this.shadowRoot.appendChild(da.content.cloneNode(!0)), this.shadowRoot.querySelector(".container").addEventListener("click", (function (s) {
    ...
    customElements.define("game-switch", ua);
    ...
    customElements.define("game-help", pa);
    ...
    var ha = function (e) {
        ...
        return o(t, [{
            ...
            value: function () {
                var e = this;
                this.shadowRoot.appendChild(ma.content.cloneNode(!0)), this.shadowRoot.querySelector("game-icon").addEventListener("click", (function (s) {
    ...
    customElements.define("game-page", ha);
        ...
        ba = function (e) {
            ...
            return o(t, [{
                ...
                value: function () {
                    ...
                    this.shadowRoot.querySelector("path").setAttribute("d", ga[e]), "backspace" === e && this.shadowRoot.querySelector("path").setAttribute("fill", "var(--color-tone-1)")
                }
            }]), t
        }(c(HTMLElement));
    customElements.define("game-icon", ba);
            ...
            return o(t, [{
                ...
                value: function () {
                    var e = (new Date).getTime(),
                        ...
                        a = Math.floor(s % 864e5 / va),
                        t = Math.floor(s % va / ka),
                        o = Math.floor(s % ka / 1e3),
                ...
                value: function () {
                    var e = this;
                    this.shadowRoot.appendChild(fa.content.cloneNode(!0)), this.$timer = this.shadowRoot.querySelector("#timer"), this.intervalId = setInterval((function () {
                        e.updateTimer()
                    }), 200)
                }
            }]), t
        }(c(HTMLElement));
    return customElements.define("countdown-timer", wa),
        function () {
            var e;
        ...
        }(), e.CountdownTimer = wa, e.GameApp = Ks, e.GameHelp = pa, e.GameIcon = ba, e.GameKeyboard = ta, e.GameModal = Qs, e.GamePage = ha, e.GameRow = x, e.GameSettings = _s, e.GameStats = la, e.GameSwitch = ua, e.GameThemeManager = _, e.GameTile = v, e.GameToast = Es, Object.defineProperty(e, "__esModule", {
            value: !0
        }), e
}({});
//# sourceMappingURL=main.53348285.js.map